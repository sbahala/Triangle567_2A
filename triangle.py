...
def classify_triangle(side_a,side_b,side_c):
    ...
    if not((isinstance(side_a,int) and isinstance(side_b,int) and isinstance(side_c,int)) and
           (side_a < 200 or side_b < 200 or side_c < 200) and
    ...
    if (((side_a ** 2) + (side_b ** 2)) == (side_c ** 2) or
        ...
        return 'Right'
    if side_a not in [side_b,side_c]:
        return 'Scalene'
    return 'Isoceles'
